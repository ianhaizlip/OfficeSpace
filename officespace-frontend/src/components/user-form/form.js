                            ...
                            <div className="user-form shadow">
                                ...
                                <div className="form-group">
                                    ...
                                    <input onKeyUp={this.onKeyUpInputTextImgUrl} type="text" className="form-control"
                                           id="inputTextImgUrl" placeholder="URL"/>
                                </div>
                                <div className="form-group">
